...
Word lists: `words-en.js` / `words-cs.js` come from
https://github.com/hermitdave/FrequencyWords (OpenSubtitles 2018,
CC-BY-SA-4.0), top 3000 per language, regenerated by filtering to valid
