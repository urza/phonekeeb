...
export const LAYOUTS = {
  ...
  'qwerty-8pen': {
    label: 'QWERTY 8pen',
    // Every glyph keeps its ring (crossing count) from original-8pen,
    // so gesture cost stays identical; within each ring the eight
    // slots go to the glyphs whose direction from the QWERTY keyboard
    // center best matches the slot's on-screen direction. Generated by
    // tools/generate-qwerty8pen.mjs (exact per-ring assignment,
    // punctuation weighted 0.3 so letters win contested spots); edit
    // and re-run that script instead of hand-editing this map. The
    // worst letter compromises are d, k, g at 58 degrees off, all
    // near the keyboard center where direction matters least.
    static: {
      N: { CW: ['y', 'u', 'k', '!'], CCW: ['t', 'r', 'g', '@'] },
      E: { CW: ['o', 'l', 'm', "'"], CCW: ['i', 'h', 'p', 'j'] },
      S: { CW: ['.', 'd', 'c', 'v'], CCW: [',', 'n', 'b', '?'] },
      W: { CW: ['e', 's', 'w', 'q'], CCW: ['a', 'x', 'f', 'z'] },
    },
  },
