...
export const LAYOUTS = {
  ...
  'qwerty-8pen': {
    ...
    // instead of hand-editing this map. On top of the computed
    // assignment the script applies hand-tuned swaps (a and s traded
    // places so the word "is" traces a figure eight); the dated
    // reasoning for each swap is in layout-tuning.md. The six null
    // slots in ring 4 are reserved real estate and must stay empty.
    static: {
